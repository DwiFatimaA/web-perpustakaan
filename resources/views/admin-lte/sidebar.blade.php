 <aside class="main-sidebar sidebar-light-dark elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/adminlte/dist/img/zarbook.png" alt="zarbook Logo" class="brand-image img-circle elevation-3" style="opacity: .8 " >
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/adminlte/dist/img/azzahra.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
