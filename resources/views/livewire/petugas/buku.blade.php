<div class="row">
    ...
    <div class="card">
        ...
        <span wire:click="create" class="btn btn-sm btn-info">Tambah</span>
            ...
            <table class="table table-hover text-nowrap">
                ...
                @foreach ($buku as $item)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <span wire:click="show({{$item->id}})" class="btn btn-sm btn-info mr-2">Lihat</span>
                                <span wire:click="edit({{$item->id}})" class="btn btn-sm btn-success mr-2">Edit</span>
