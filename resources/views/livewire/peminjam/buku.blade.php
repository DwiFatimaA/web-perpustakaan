  ...
  @if ($detail_buku)
      ...
      <div class="row">
          ...
          <div class="col-md-8" >
              ...
              {{-- <button wire:click="keranjang({{$buku->id}})" class="btn btn-success" style="background: linear-gradient(to right, #00cc00, #006600);">Keranjang</button> --}}
          </div>
      </div>
          ...
          <div class="row" >
              @foreach ($buku as $item)
                  <div class="col-lg-3 col-md-4 col-sm-6" >
                      ...
                      <div class="card-body" style="background: linear-gradient(to bottom right, #ffffff, #674188);">
